...
public class str : MonoBehaviour
{
    ...
    void OnMouseDown()
    {
        ...
        while (selectm.Read())
        {
            IDataReader selectd = dbConnector.Select("SELECT str_c FROM click");
            ...
            while (selectd.Read())
            {
                ...
                if (selectd.GetInt32(0) <= selectm.GetInt32(0))
                {
                    ...
                    IDataReader selectAllFromPlayer1 = dbConnector.Select("SELECT str_c FROM click");
                    while (selectAllFromPlayer1.Read())
                    {
                        ...
                        updateQuery1 = "UPDATE click SET str_c = " + a1;
